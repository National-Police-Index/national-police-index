  ...
  return (
    <div className='w-5/6 mx-auto lg:py-28 py-12 flex gap-8 lg:flex-row flex-col justify-between lg:items-end items-start'>
      <div className='w-full flex flex-col justify-start items-start gap-8'>
        <div className='self-stretch justify-start text-emerald-950 text-5xl font-bold font-["Inter"] tracking-wide'>
          {title}
        </div>
        {description && <div className='self-stretch justify-start text-emerald-950 text-lg font-normal font-["Inter"] tracking-wide'>
          {description}
        </div>}
      </div>
