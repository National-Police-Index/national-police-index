  ...
  return (
    ...
    >
      <div className="w-full flex flex-col justify-start items-start">
        <h1
          className={
            'self-stretch justify-start text-[#122823] font-bold font-["Inter"] leading-[1.2] ' +
            (titleCapitalize ? styles.titleCapitalize : styles.title)
          }
        >
          {title}
        </h1>
        {description && (
          <div
            className={
              'self-stretch justify-start text-[#122823] font-normal font-["Inter"] leading-[1.5] ' +
              styles.description
            }
          >
            {description}
      ...
      {statistics && statistics.length > 0 && (
        <div
          className={`flex flex-col justify-center items-start gap-8 ${styles.statistics}`}
        >
            ...
            .map((stat, index) => (
              ...
              >
                {stat.value === -1 ? (
                  ...
                  <div
                    className={
                      'justify-start text-[#2F5E50] font-bold font-["Inter"] leading-[1.2] ' +
                      styles.statValue
                    }
                  >
                ...
                <div
                  className={
                    'self-stretch justify-start text-emerald-700 font-semibold font-["Inter"] tracking-[-.005em] leading-[1.5] ' +
                    styles.statLabel
                  }
                >
                  {stat.value === -1
                ...
                {stat.tooltip && (
                  <small className={styles.tooltip}>{stat.tooltip}</small>
                )}
              </div>
            ))}
        </div>
