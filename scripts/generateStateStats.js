...
function processStateChunk(states, statsCollection) {
    return __awaiter(this, void 0, void 0, function () {
        var batch, batchCount, retryCount, MAX_RETRIES, _loop_1, _i, states_2, state, error_2;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    _loop_1 = function (state) {
                        var stateRef, officersRef, lastDoc, endDateStats, startDateStats, totalOfficers, hasMoreDocs, pageCount, lastDoc_1, q, snapshot, stateStats, statsDoc, error_3, stateStats, statsDoc, writeError_1;
                        return __generator(this, function (_b) {
                            switch (_b.label) {
                                ...
                                case 6:
                                    stateStats = {
                                        title: state.name,
                                        description: "Police officer records and history in ".concat(state.name),
                                        stats: [
                                            {
                                ...
                                case 15:
                                    ...
                                    console.error("Error storing partial results for ".concat(state.name, ":"), writeError_1);
                                    return [3 /*break*/, 16];
