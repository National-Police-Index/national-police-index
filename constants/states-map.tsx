...
export const US_STATES_MAP = {
    'a0': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[84.73px] top-[169.50px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a1': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[169.50px] absolute bg-lime-100 border-4 border-white" />
    ...
    'a2': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[169.50px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a3': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[169.50px] absolute bg-lime-100 border-4 border-white" />
    ...
    'a4': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[169.50px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a5': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[169.50px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a6': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[169.50px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a7': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[84.73px] top-[254.25px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a8': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[254.25px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a9': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[254.25px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a10': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[254.25px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a11': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[254.25px] absolute bg-lime-100 border-4 border-white" />
    ...
    'a12': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[254.25px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a13': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[254.25px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a14': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.84px] top-[254.25px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a15': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[254.25px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a16': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[847.30px] top-[254.25px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a17': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[84.73px] top-[339px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a18': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[339px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a19': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[339px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a20': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[339px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a21': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[339px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a22': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[339px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a23': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[339px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a24': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.84px] top-[339px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a25': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[339px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a26': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[847.30px] top-[339px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a27': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a28': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a29': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a30': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[423.75px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a31': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a32': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a33': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.84px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a34': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[423.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a35': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.16px] top-[508.50px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a36': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[422.89px] top-[508.50px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a37': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[507.62px] top-[508.50px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a38': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[592.35px] top-[508.50px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a39': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.08px] top-[508.50px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a40': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[761.81px] top-[169.50px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a41': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[846.54px] top-[169.50px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a42': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[931.27px] top-[169.50px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a43': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[846.54px] top-[84.75px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a44': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[931.27px] top-[84.75px] absolute bg-amber-100 border-4 border-white" />
    ...
    'a45': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[931.27px] top-0 absolute bg-amber-100 border-4 border-white" />
    ...
    'a46': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[84.75px] absolute bg-rose-200 border-4 border-white" />
    ...
    'a47': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-0 top-[84.75px] absolute bg-lime-100 border-4 border-white" />
    ...
    'a48': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-0 top-[508.50px] absolute bg-lime-100 border-4 border-white" />
    ...
    'a49': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[593.25px] absolute bg-emerald-200 border-4 border-white" />
    ...
    'a50': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[593.25px] absolute bg-emerald-200 border-4 border-white" />
