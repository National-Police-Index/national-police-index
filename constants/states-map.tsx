...
export const US_STATES_MAP = {
  'a0': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[67.38px] top-[134.75px] absolute">
            
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.38347 67.125V1.75H66.7669V67.125H1.38347Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[134.77px] top-[134.75px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.76694 67.125V1.75H67.1504V67.125H1.76694Z" fill="#BEBEBE" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a4': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[202.15px] top-[134.75px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.15039 67.125V1.75H66.5339V67.125H1.15039Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a6': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[269.53px] top-[134.75px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.53387 67.125V1.75H66.9173V67.125H1.53387Z" fill="#BEBEBE" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a8': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[336.92px] top-[134.75px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.91736 67.125V1.75H67.3008V67.125H1.91736Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[349.39px] top-[157.96px] absolute">
            ...
            <svg width="43" height="22" viewBox="0 0 43 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.387512 0.964905H3.42339L10.5606 18.3964H10.8067L17.9445 0.964905H20.9804V21.9648H18.6009V6.0096H18.3957L11.8325 21.9648H9.53543L2.97216 6.0096H2.767V21.9648H0.387512V0.964905ZM42.445 0.964905V21.9648H39.9837L28.5394 5.47662H28.3342V21.9648H25.7905V0.964905H28.2518L39.7377 17.494H39.9428V0.964905H42.445Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a10': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[404.30px] top-[134.75px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.30078 67.125V1.75H66.6842V67.125H1.30078Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[428.50px] top-[157.96px] absolute">
            ...
            <svg width="21" height="22" viewBox="0 0 21 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.04667 0.964905V21.9648H0.50293V0.964905H3.04667ZM7.85677 21.9648V0.964905H10.4005V19.709H20.1633V21.9648H7.85677Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a12': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[471.68px] top-[134.75px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.68433 67.125V1.75H67.0678V67.125H1.68433Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[491.37px] top-[157.96px] absolute">
            ...
            <svg width="29" height="22" viewBox="0 0 29 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.374146 0.964905H3.41002L10.5472 18.3964H10.7933L17.9312 0.964905H20.967V21.9648H18.5875V6.0096H18.3824L11.8191 21.9648H9.52206L2.9588 6.0096H2.75363V21.9648H0.374146V0.964905ZM28.3208 0.964905V21.9648H25.7771V0.964905H28.3208Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[67.38px] top-[202.12px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.38347 66.5V1.125H66.7669V66.5H1.38347Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[134.77px] top-[202.12px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.76694 66.5V1.125H67.1504V66.5H1.76694Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a18': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[202.15px] top-[202.12px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.15039 66.5V1.125H66.5339V66.5H1.15039Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a20': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[269.53px] top-[202.12px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.53387 66.5V1.125H66.9173V66.5H1.53387Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a22': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[336.92px] top-[202.12px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.91736 66.5V1.125H67.3008V66.5H1.91736Z" fill="#BEBEBE" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a22': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[359.62px] top-[225.34px] absolute">
            ...
            <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.1591 0.339905V21.3398H0.615356V0.339905H3.1591ZM8.83074 21.3398H6.16428L13.8767 0.339905H16.5016L24.2134 21.3398H21.5475L15.2713 3.66234H15.107L8.83074 21.3398ZM9.8156 13.1369H20.5627V15.3928H9.8156V13.1369Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a24': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[404.30px] top-[202.12px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.30078 66.5V1.125H66.6842V66.5H1.30078Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a24': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[425.80px] top-[225.34px] absolute">
            ...
            <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.33927 0.339905V21.3398H0.795532V0.339905H3.33927ZM24.8039 0.339905V21.3398H22.3426L10.8982 4.85162H10.6931V21.3398H8.14937V0.339905H10.6107L22.0965 16.869H22.3017V0.339905H24.8039Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a26': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[471.68px] top-[202.12px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.68433 66.5V1.125H67.0678V66.5H1.68433Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a28': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[539.07px] top-[202.12px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.06775 66.5V1.125H66.4512V66.5H1.06775Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a30': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[606.45px] top-[202.12px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.45123 66.5V1.125H66.8347V66.5H1.45123Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a32': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[673.83px] top-[202.12px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.83472 66.5V1.125H67.2182V66.5H1.83472Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a34': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[67.38px] top-[269.50px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.38347 66.875V1.5H66.7669V66.875H1.38347Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a36': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[134.77px] top-[269.50px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.76694 66.875V1.5H67.1504V66.875H1.76694Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[150.25px] top-[292.71px] absolute">
            ...
            <svg width="38" height="22" viewBox="0 0 38 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.8998 0.714905V21.7148H14.4385L2.99358 5.22662H2.78902V21.7148H0.2453V0.714905H2.70659L14.1925 17.244H14.3976V0.714905H16.8998ZM22.5619 0.714905L28.7966 18.3924H29.0427L35.2781 0.714905H37.9445L30.2327 21.7148H27.6072L19.8954 0.714905H22.5619Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a38': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[202.15px] top-[269.50px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.15039 66.875V1.5H66.5339V66.875H1.15039Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a40': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[269.53px] top-[269.50px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.53387 66.875V1.5H66.9173V66.875H1.53387Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[286.22px] top-[292.71px] absolute">
            ...
            <svg width="35" height="22" viewBox="0 0 35 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.87 0.714905V21.7148H14.4087L2.96378 5.22662H2.75921V21.7148H0.215485V0.714905H2.67679L14.1627 17.244H14.3678V0.714905H16.87ZM21.6705 21.7148V0.714905H34.3458V2.97076H24.2136V10.0662H33.6894V12.322H24.2136V19.459H34.5101V21.7148H21.6705Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a42': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[336.92px] top-[269.50px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.91736 66.875V1.5H67.3008V66.875H1.91736Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a44': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[404.30px] top-[269.50px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.30078 66.875V1.5H66.6842V66.875H1.30078Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a46': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[471.68px] top-[269.50px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.68433 66.875V1.5H67.0678V66.875H1.68433Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[482.53px] top-[292.71px] absolute">
            ...
            <svg width="46" height="22" viewBox="0 0 46 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M6.27021 21.7148L0.527588 0.714905H3.11161L7.50118 17.8185H7.70634L12.1771 0.714905H15.0487L19.5201 17.8185H19.7253L24.1142 0.714905H26.6988L20.9556 21.7148H18.3307L13.695 4.98059H13.5308L8.89577 21.7148H6.27021ZM30.4404 0.714905L36.6752 18.3924H36.9213L43.1566 0.714905H45.8231L38.1113 21.7148H35.4858L27.774 0.714905H30.4404Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a48': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[539.07px] top-[269.50px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.06775 66.875V1.5H66.4512V66.875H1.06775Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a48': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[554.85px] top-[292.71px] absolute">
            ...
            <svg width="37" height="22" viewBox="0 0 37 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.51339 0.714905L9.74877 18.3924H9.99484L16.2296 0.714905H18.8961L11.1843 21.7148H8.55872L0.846924 0.714905H3.51339ZM20.9356 21.7148H18.2692L25.981 0.714905H28.6065L36.3183 21.7148H33.6518L27.3755 4.03734H27.2113L20.9356 21.7148ZM21.9199 13.5119H32.6676V15.7678H21.9199V13.5119Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a50': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[606.45px] top-[269.50px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.45123 66.875V1.5H66.8347V66.875H1.45123Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a52': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[673.83px] top-[269.50px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.83472 66.875V1.5H67.2182V66.875H1.83472Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a54': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[134.77px] top-[336.88px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.76694 67.25V1.875H67.1504V67.25H1.76694Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a56': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[202.15px] top-[336.88px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.15039 67.25V1.875H66.5339V67.25H1.15039Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a56': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[214.62px] top-[360.09px] absolute">
            ...
            <svg width="43" height="22" viewBox="0 0 43 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M17.2751 0.0899048V21.0898H14.8138L3.36884 4.60162H3.16427V21.0898H0.620544V0.0899048H3.08185L14.5677 16.619H14.7729V0.0899048H17.2751ZM22.0756 0.0899048H25.1108L32.2487 17.5214H32.4947L39.6326 0.0899048H42.6678V21.0898H40.289V5.1346H40.0838L33.5205 21.0898H31.2229L24.6596 5.1346H24.4545V21.0898H22.0756V0.0899048Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a58': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[269.53px] top-[336.88px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.53387 67.25V1.875H66.9173V67.25H1.53387Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a60': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[336.92px] top-[336.88px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.91736 67.25V1.875H67.3008V67.25H1.91736Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a62': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[404.30px] top-[336.88px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.30078 67.25V1.875H66.6842V67.25H1.30078Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a62': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[419.23px] top-[360.09px] absolute">
            ...
            <svg width="37" height="22" viewBox="0 0 37 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.2323 2.34576V0.0899048H15.9844V2.34576H9.38022V21.0898H6.83647V2.34576H0.2323ZM36.2752 0.0899048V21.0898H33.8139L22.369 4.60162H22.1638V21.0898H19.6207V0.0899048H22.082L33.5679 16.619H33.773V0.0899048H36.2752Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a64': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[471.68px] top-[336.88px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.68433 67.25V1.875H67.0678V67.25H1.68433Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a66': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[539.07px] top-[336.88px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.06775 67.25V1.875H66.4512V67.25H1.06775Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a68': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[606.45px] top-[336.88px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.45123 67.25V1.875H66.8347V67.25H1.45123Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a70': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[268.93px] top-[404.25px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.93222 66.625V1.25H67.3157V66.625H1.93222Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a72': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[336.32px] top-[404.25px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.3157 66.625V1.25H66.6992V66.625H1.3157Z" fill="#A6A6A6" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a72': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[353.90px] top-[427.46px] absolute">
            ...
            <svg width="35" height="22" viewBox="0 0 35 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.89978 21.4648V0.464905H3.44352V19.209H13.2063V21.4648H0.89978ZM19.0422 21.4648H16.3757L24.0881 0.464905H26.7131L34.4249 21.4648H31.759L25.4827 3.78734H25.3185L19.0422 21.4648ZM20.0271 13.2619H30.7741V15.5178H20.0271V13.2619Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a74': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[403.70px] top-[404.25px] absolute">
            ...
            <svg width="69" height="68" viewBox="0 0 69 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.69919 66.625V1.25H67.0827V66.625H1.69919Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a76': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[471.08px] top-[404.25px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.08264 66.625V1.25H66.4661V66.625H1.08264Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a76': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[487.76px] top-[427.46px] absolute">
            ...
            <svg width="35" height="22" viewBox="0 0 35 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.43075 21.4648H0.764282L8.47608 0.464905H11.1016L18.8134 21.4648H16.147L9.87129 3.78734H9.70704L3.43075 21.4648ZM4.41502 13.2619H15.1627V15.5178H4.41502V13.2619ZM21.7964 21.4648V0.464905H24.3395V19.209H34.1022V21.4648H21.7964Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a78': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[538.47px] top-[404.25px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.46613 66.625V1.25H66.8496V66.625H1.46613Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a80': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[605.85px] top-[134.75px] absolute">
            ...
            <svg width="69" height="69" viewBox="0 0 69 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.84955 67.125V1.75H67.233V67.125H1.84955Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a82': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[673.23px] top-[134.75px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.23303 67.125V1.75H66.6165V67.125H1.23303Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a84': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[740.62px] top-[134.75px] absolute">
            ...
            <svg width="68" height="69" viewBox="0 0 68 69" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.61652 67.125V1.75H67V67.125H1.61652Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a86': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[673.23px] top-[67.38px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.23303 66.75V1.375H66.6165V66.75H1.23303Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a86': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[688.71px] top-[90.59px] absolute">
            ...
            <svg width="37" height="22" viewBox="0 0 37 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M3.37848 0.589905L9.61145 18.2674H9.85814L16.0971 0.589905H18.7623L11.0494 21.5898H8.42624L0.713196 0.589905H3.37848ZM20.5974 2.84576V0.589905H36.3482V2.84576H29.7422V21.5898H27.1973V2.84576H20.5974Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a88': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[740.62px] top-[67.38px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.61652 66.75V1.375H67V66.75H1.61652Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a88': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[755.19px] top-[90.59px] absolute">
            ...
            <svg width="38" height="22" viewBox="0 0 38 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M16.8476 0.589905V21.5898H14.3868L2.94374 5.10162H2.73311V21.5898H0.194214V0.589905H2.65489L14.1402 17.119H14.3448V0.589905H16.8476ZM21.6486 21.5898V0.589905H24.1936V9.94119H35.39V0.589905H37.935V21.5898H35.39V12.1971H24.1936V21.5898H21.6486Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a90': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[740.62px] top-0 absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.61652 66.375V1H67V66.375H1.61652Z" fill="#787878" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a90': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[755.49px] top-[23.21px] absolute">
            ...
            <svg width="39" height="22" viewBox="0 0 39 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.494995 0.214844H3.52727L10.6687 17.6465H10.9154L18.0508 0.214844H21.083V21.2148H18.7066V5.25979H18.5021L11.9382 21.2148H9.63994L3.07605 5.25979H2.87151V21.2148H0.494995V0.214844ZM25.8961 21.2148V0.214844H38.5727V2.4707H28.4411V9.56643H37.9169V11.8223H28.4411V18.959H38.7351V21.2148H25.8961Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a92': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[404.30px] top-[67.38px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.30078 66.75V1.375H66.6842V66.75H1.30078Z" fill="#484848" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[421.16px] top-[90.59px] absolute">
            ...
            <svg width="32" height="22" viewBox="0 0 32 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M5.90315 21.5898L0.160522 0.589905H2.74455L7.13411 17.6935H7.33927L11.81 0.589905H14.6817L19.153 17.6935H19.3582L23.7471 0.589905H26.3318L20.5885 21.5898H17.9636L13.328 4.85559H13.1637L8.52871 21.5898H5.90315ZM31.7549 0.589905V21.5898H29.2118V0.589905H31.7549Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a94': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-0 top-[67.38px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 66.75V1.375H66.3835V66.75H1Z" fill="#BEBEBE" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a96': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-0 top-[404.25px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1 66.625V1.25H66.3835V66.625H1Z" fill="#BEBEBE" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  '_a96': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[21.80px] top-[427.46px] absolute">
            ...
            <svg width="25" height="22" viewBox="0 0 25 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.795715 21.4648V0.464905H3.33896V9.81618H14.5377V0.464905H17.081V21.4648H14.5377V12.072H3.33896V21.4648H0.795715ZM24.4272 0.464905V21.4648H21.8839V0.464905H24.4272Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a98': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[269.53px] top-[471.62px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.53387 67V1.625H66.9173V67H1.53387Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
  ...
  'a100': {
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[606.45px] top-[471.62px] absolute">
            ...
            <svg width="68" height="68" viewBox="0 0 68 68" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M1.45123 67V1.625H66.8347V67H1.45123Z" fill="#EAE9E9" stroke="white" strokeWidth="2" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
    ...
    svg: (state: State, onClick: (abbreviation: string) => void) => (
        <div className="left-[626.14px] top-[494.84px] absolute">
            ...
            <svg width="30" height="22" viewBox="0 0 30 22" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M0.142883 21.8398V0.839844H12.7352V3.0957H2.68178V10.1911H11.7906V12.447H2.68178V21.8398H0.142883ZM16.8023 21.8398V0.839844H19.3472V19.5839H29.1058V21.8398H16.8023Z" fill="black" onClick={() => onClick(state.abbreviation)}
            className="cursor-pointer transition-colors duration-200 hover:opacity-80 focus:outline-none focus:ring-2 focus:ring-blue-500"/>
            </svg>
        </div>
    )
