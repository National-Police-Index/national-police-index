...
export const US_STATES_MAP = {
    'a0': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[84.73px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a1': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a2': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a3': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a4': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a5': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a6': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a7': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[84.73px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a8': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a9': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a10': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a11': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a12': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a13': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a14': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.84px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a15': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a16': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[847.30px] top-[254.25px] absolute" tabIndex={0} />
    ...
    'a17': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[84.73px] top-[339px] absolute" tabIndex={0} />
    ...
    'a18': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[339px] absolute" tabIndex={0} />
    ...
    'a19': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[339px] absolute" tabIndex={0} />
    ...
    'a20': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[339px] absolute" tabIndex={0} />
    ...
    'a21': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[339px] absolute" tabIndex={0} />
    ...
    'a22': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[339px] absolute" tabIndex={0} />
    ...
    'a23': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[339px] absolute" tabIndex={0} />
    ...
    'a24': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.84px] top-[339px] absolute" tabIndex={0} />
    ...
    'a25': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[339px] absolute" tabIndex={0} />
    ...
    'a26': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[847.30px] top-[339px] absolute" tabIndex={0} />
    ...
    'a27': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[169.46px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a28': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[254.19px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a29': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a30': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.65px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a31': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a32': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.11px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a33': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[677.84px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a34': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[423.75px] absolute" tabIndex={0} />
    ...
    'a35': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[339.16px] top-[508.50px] absolute" tabIndex={0} />
    ...
    'a36': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[423.89px] top-[508.50px] absolute" tabIndex={0} />
    ...
    'a37': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.62px] top-[508.50px] absolute" tabIndex={0} />
    ...
    'a38': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[593.35px] top-[508.50px] absolute" tabIndex={0} />
    ...
    'a39': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[678.08px] top-[508.50px] absolute" tabIndex={0} />
    ...
    'a40': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[761.81px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a41': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[846.54px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a42': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[931.27px] top-[169.50px] absolute" tabIndex={0} />
    ...
    'a43': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[846.54px] top-[84.75px] absolute" tabIndex={0} />
    ...
    'a44': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[931.27px] top-[84.75px] absolute" tabIndex={0} />
    ...
    'a45': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[931.27px] top-0 absolute" tabIndex={0} />
    ...
    'a46': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[508.38px] top-[84.75px] absolute" tabIndex={0} />
    ...
    'a47': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-0 top-[84.75px] absolute" tabIndex={0} />
    ...
    'a48': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-0 top-[508.50px] absolute" tabIndex={0} />
    ...
    'a49': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[338.92px] top-[593.25px] absolute" tabIndex={0} />
    ...
    'a50': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                <div className="w-20 h-20 left-[762.57px] top-[593.25px] absolute" tabIndex={0} />
