    ...
    'a51': {
        renderSvg: (state: State, onClick: (reference: string) => void) => (
            <div onClick={() => onClick(state.reference)}>
                ...
                <div data-svg-wrapper className="left-[950.20px] top-[726.22px] absolute">
                    <svg width="30" height="18" viewBox="0 0 30 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.6775 17.61V0H22.6252C23.9551 0 25.0901 0.237896 26.0302 0.713687C26.9761 1.18375 27.6955 1.85157 28.1885 2.71717C28.6872 3.57703 28.9366 4.5888 28.9366 5.75249C28.9366 6.9219 28.6843 7.92794 28.1799 8.77061C27.6754 9.60754 26.9445 10.2496 25.9872 10.6967C25.0356 11.1438 23.8834 11.3674 22.5306 11.3674H17.8787V8.37507H21.9287C22.6395 8.37507 23.2299 8.27762 23.7 8.08272C24.17 7.88781 24.5197 7.59546 24.749 7.20566C24.984 6.81585 25.1016 6.33146 25.1016 5.75249C25.1016 5.16778 24.984 4.67479 24.749 4.27352C24.5197 3.87225 24.1672 3.56843 23.6914 3.36207C23.2213 3.14997 22.628 3.04392 21.9115 3.04392H19.4007V17.61H15.6775ZM25.1875 9.59608L29.5643 17.61H25.4541L21.172 9.59608H25.1875Z" fill="#122823"/>
