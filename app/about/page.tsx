        ...
        <div className={`container-a mx-auto ${styles.container}`}>
          ...
          <section className="w-full">
            <div className="w-full pt-4 border-t border-[#2F5E50] inline-flex justify-start items-center gap-2.5">
              <div className="justify-start text-[#122823] text-4xl font-bold font-['Inter'] leading-[48px] tracking-tight">
                Team
              </div>
            </div>
            ...
            <div className={`w-full mx-auto`}>
              {loading ? (
                ...
                <div
                  className={`w-full flex flex-wrap gap-6 ${styles.teamSection}`}
                >
